...
class CharacteristicForm extends Model
{
    ...
    public function __construct(Characteristics $characteristic = null, $config = [])
    {
        if ($characteristic) {
            ...
            $this->sort = Characteristics::find()->max('sort') + 1;
        }
    ...
    public function rules(): array
    {
        return [
            ...
            [['textVariants'], 'string'],
            [['sort'], 'integer'],
            [['name'], 'unique', 'targetClass' => Characteristics::class, 'filter' => $this->_characteristic ? ['<>', 'id', $this->_characteristic->id] : null]
        ];
    }
